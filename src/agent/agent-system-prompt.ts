...
export function modeBlock(proposalMode: boolean): string {
  return proposalMode
    ? [
        ...
        '- Gdy zmiana dotyczy JEDNEJ pozycji w propozycji, która jeszcze czeka na zatwierdzenie',
        '  (status=PENDING w historii), używasz revise_proposal — nie układasz jej od nowa.',
