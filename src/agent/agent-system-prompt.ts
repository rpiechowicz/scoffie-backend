...
export const AGENT_INSTRUCTIONS = [
  ...
  '  revise_proposal, offer_options, ask_clarifying_question) KOŃCZY turę: jedno krótkie zdanie',
  '  piszesz W TEJ SAMEJ wiadomości, przed wywołaniem — potem głosu już nie dostaniesz. Jedna',
  '  wiadomość = jedna karta. Gdy narzędzie odmówi (naruszenia, błąd), poprawiasz i piszesz',
  '  odpowiedź od nowa razem z kolejnym wywołaniem.',
