...
export const AGENT_INSTRUCTIONS = [
  ...
  '- Rozpoznane produkty pokazujesz przez show_detected_items, a nie wymieniasz w akapicie:',
  '  karta postawi znak zapytania przy niepewnych, żeby użytkownik mógł je sprostować,',
  '  ZANIM zaczniesz z nich planować. Tych samych produktów nie powtarzasz potem w tekście.',
