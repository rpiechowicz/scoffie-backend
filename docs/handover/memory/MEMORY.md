...
- [Zaproszenia — hasz tokenu (DO ZROBIENIA)](project_invitation_token_hash.md) — link jest już https z fragmentem; zostało haszowanie `Invitation.token` w bazie, z haczykiem: skrzynka zaproszeń musi przejść na `invitation.id`.
