...
import {
  buildOptionsCard,
  optionPrompt,
} from '../src/agent/cards/options-card';
...
const card = buildPlanWeekCard({
  ...
  preview: {
    ...
    slots: [
      {
        ...
        kcalPerServing: 620,
        prepTimeMinutes: 30,
        imageUrl: 'https://example.invalid/kurczak.png',
        participantIds: [],
        change: 'NEW',
      },
      {
    ...
    removed: [
      { dayOfWeek: 'WED', mealType: 'DINNER', title: 'Zupa pomidorowa' },
    ],
  } as never,
  ...
  preview: {
    ...
    slots: [
      ...
      },
      {
        ...
        mealType: 'LUNCH',
        recipeId: 'r-1',
        title: 'Kurczak w sosie curry z ryżem',
        kcalPerServing: 620,
        prepTimeMinutes: 35,
        imageUrl: null,
        participantIds: [],
  ...
  options: [
    {
      ...
      kcalPerServing: 393,
      prepTimeMinutes: 12,
      imageUrl: 'https://example.invalid/omlet.jpg',
      description: 'Puszysty omlet z dwóch jaj ze szpinakiem i fetą.',
      proteinGrams: 26,
      carbsGrams: 6,
      fatGrams: 30,
      ingredientCount: 6,
      tag: 'Najszybsze',
      prompt: optionPrompt('Omlet ze szpinakiem i fetą'),
    },
    {
      recipeId: 'r-7',
      title: 'Sałatka z tuńczykiem',
      ...
      prepTimeMinutes: 15,
      imageUrl: null,
      // Karta zapisana w historii przed 21.09.2026 — bez danych szczegółu.
      description: null,
      proteinGrams: null,
      carbsGrams: null,
      fatGrams: null,
      ...
      tag: null,
      prompt: optionPrompt('Sałatka z tuńczykiem'),
    },
    {
      recipeId: 'r-8',
      ...
      prepTimeMinutes: 10,
      imageUrl: null,
      description: 'Chrupiący tost z awokado i jajkiem sadzonym.',
      proteinGrams: 18,
      carbsGrams: 32,
      fatGrams: 24,
      ingredientCount: 5,
      tag: 'Najwięcej białka',
      prompt: optionPrompt('Tost z awokado i jajkiem'),
    },
  ],
});
  ...
  portions: [
    {
      ...
      displayName: 'Rafał',
      goalLabel: '2100 kcal',
      note: 'Duża porcja + kasza 100 g',
      kcal: 740,
    },
    {
      userId: 'u-2',
      displayName: 'Ania',
      goalLabel: '1750 kcal · wegetariańska',
      note: 'Bez mięsa, więcej kaszy',
      kcal: 590,
    },
    {
      userId: 'u-3',
      displayName: 'Zosia',
      goalLabel: '1400 kcal · bez laktozy',
      note: 'Śmietana osobno',
      kcal: 420,
    },
  ],
  expiresAt: new Date('2026-09-03T10:00:00.000Z'),
